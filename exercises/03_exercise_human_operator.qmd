...
-   [9 - Data Structures](https://lifi.datalit.de/lifi-project/data-structures)
...
- Write a program that allows the user to control the color of the LED using the rotary encoder. The user can increase or decrease the intensity of a the currently controlled base color by turning the knob in the right or left direction.
