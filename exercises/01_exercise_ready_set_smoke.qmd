...
4.  Run the program from a terminal and check the output for potential errors.
...
-   A screenshot (.jpg or .png) from your computer in which the `smoke_test.py` is opened in Visual Studio Code and the terminal shows a successful smoke test run
